...
namespace Projekt3
{
    class Program
    {
        ...
        {
            CreateRandomTab("InsertionSort");
            CreateRandomTab("SelectionSort");
            CreateRandomTab("HeapSort");
            CreateRandomTab("CocktailSort");
        ...
        public static void CreateRandomTab(string sortType)
        {
